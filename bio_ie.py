...
if __name__ == '__main__':
    ...
    options = OptionConfig(model_name='LstmCrf', epochs=5, batch_size=32,
    ...
    # NER
    #main('r', 'ner', 'CONLL2003', ('train', 'dev', 'test'), 'iii', tcfg, epo=0)
    ...
    #main('r', 'ner', 'NCBI', ('train', 'dev', 'test'), 'aaa', tcfg, epo=0)
